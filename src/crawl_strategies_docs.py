...
def crawl_strategies():
    """Crawl TradingView built-in strategies documentation."""
    URL = "https://www.tradingview.com/support/folders/43000587406-built-in-strategies/"
    OUTPUT_DIR = "../docs/markdown/built-in-strategies"

    print(f"Crawling built-in strategies from {URL}...")
    ...
    try:
        pbar = tqdm(urls, desc="Processing strategies")
        ...
        print(f"\n✓ Successfully crawled {len(urls)} strategies to {OUTPUT_DIR}")
